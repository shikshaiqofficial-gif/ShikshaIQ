...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to the protected student dashboard
      navigate('/dashboard');
    } catch (err) {
      ...
      <div className="max-w-5xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-slate-100">
        ...
        <div className="lg:col-span-5 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white p-8 lg:p-10 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8">
              ...
              <h2 className="text-2xl font-bold leading-snug">
                Welcome Back! <br />Resume Your Prep.
              </h2>
            </div>
            ...
            <ul className="mt-8 space-y-4 text-sm text-slate-300">
              <li className="flex items-center gap-3">
                ...
                <span>Track daily streak and rank benchmarks</span>
              </li>
              <li className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-emerald-400 shrink-0" />
                <span>Access saved doubts and bookmarks</span>
              </li>
              <li className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-emerald-400 shrink-0" />
                <span>Attempt live scheduled mock tests</span>
              </li>
            </ul>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800 text-xs text-slate-400 flex items-center gap-2">
            ...
            <span>100% Encrypted & Secure Access</span>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 p-8 lg:p-12 flex flex-col justify-center">
          <div className="mb-6">
            <h3 className="text-2xl font-black text-slate-900 tracking-tight">Sign In to Shiksha IQ</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <label className="block text-xs font-bold uppercase text-slate-600 tracking-wider">Password</label>
                <a href="#forgot" className="text-xs text-orange-600 font-semibold hover:underline">
                  Forgot Password?
                </a>
              </div>
              <div className="relative">
